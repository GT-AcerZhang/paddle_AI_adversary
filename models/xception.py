...
class Xception(object):
    ...
    def __init__(self, entry_flow_block_num=3, middle_flow_block_num=8, prefix=''):
    ...
    def entry_flow_bottleneck_block(self,
        ...
        short = fluid.layers.conv2d(
            ...
            padding=0,
            act=None,
            param_attr=ParamAttr(self.prefix + name + "_branch1_weights"),
            bias_attr=False)
    ...
    def exit_flow(self, input, class_dim):
        ...
        out = fluid.layers.fc(
            ...
            bias_attr=fluid.param_attr.ParamAttr(name=prefix + 'fc_offset'))
...
def Xception41(prefix=''):
    model = Xception(entry_flow_block_num=3, middle_flow_block_num=8, prefix=prefix)
    return model


def Xception65(prefix=''):
    model = Xception(entry_flow_block_num=3, middle_flow_block_num=16, prefix=prefix)
    return model


def Xception71(prefix=''):
    model = Xception(entry_flow_block_num=5, middle_flow_block_num=16, prefix=prefix)
    return model