...
class ResNeXt():
    def __init__(self, layers=50, cardinality=64,prefix=''):
        self.layers = layers
    ...
    def conv_bn_layer(self,
        ...
        conv = fluid.layers.conv2d(
            ...
            bias_attr=False,
            name=prefix + name + '.conv2d.output.1')
        if name == "conv1":
            bn_name = "bn_" + name
        else:
            bn_name = "bn" + name[3:]
        bn_name = prefix + bn_name
...
def ResNeXt50_32x4d(prefix=''):
    model = ResNeXt(layers=50, cardinality=32,prefix=prefix)
    return model
