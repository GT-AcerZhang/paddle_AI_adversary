...
class GoogLeNet():
    ...
    def xavier(self, channels, filter_size, name):
        ...
        param_attr = ParamAttr(
            initializer=fluid.initializer.Uniform(-stdv, stdv),
            name=self.prefix + name + "_weights")
    ...
    def inception(self,
        ...
        convprj = fluid.layers.conv2d(
            ...
            stride=1,
            padding=0,
            name=self.prefix + "inception_" + name + "_3x3_proj",
            param_attr=ParamAttr(
                name=self.prefix + "inception_" + name + "_3x3_proj_weights"),
            bias_attr=False)
    ...
    def net(self, input, class_dim=1000):
        ...
        out = fluid.layers.fc(input=dropout,
                              ...
                              name=self.prefix + "out",
                              bias_attr=ParamAttr(name=self.prefix + "out_offset"))
        ...
        fc_o1 = fluid.layers.fc(input=conv_o1,
                                ...
                                name=self.prefix + "fc_o1",
                                bias_attr=ParamAttr(name=self.prefix + "fc_o1_offset"))
        ...
        out1 = fluid.layers.fc(input=dropout_o1,
                               ...
                               name=self.prefix + "out1",
                               bias_attr=ParamAttr(name=self.prefix + "out1_offset"))
        ...
        fc_o2 = fluid.layers.fc(input=conv_o2,
                                ...
                                name=self.prefix + "fc_o2",
                                bias_attr=ParamAttr(name=self.prefix + "fc_o2_offset"))
        ...
        out2 = fluid.layers.fc(input=dropout_o2,
                               ...
                               name=self.prefix + "out2",
                               bias_attr=ParamAttr(name=self.prefix + "out2_offset"))
